...
const Location = () => {
    return (
        <section id="location" className="py-0 relative">
            <div className="flex flex-col-reverse md:grid md:grid-cols-2 md:h-[600px]">
                {/* Info Side */}
                <div className="bg-rock-dark p-8 md:p-12 flex flex-col justify-center items-start">
                ...
                {/* Map Side */}
                <div className="w-full h-[400px] md:h-full bg-gray-900 relative">
                    <iframe
                        src="https://maps.google.com/maps?q=Av.+Libertad+y+Saavedra+Villa+Carlos+Paz&t=&z=17&ie=UTF8&iwloc=&output=embed"
                        width="100%"
                        height="100%"
